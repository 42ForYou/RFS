...
const TFiber = {
    ...
    //이 자식을 조정하는 동안 ID를 보존하는 데 사용되는 element.type의 값입니다.
    // NOTE: 이 자식의 조정 중에 신원을 유지하는 데 사용되는 값입니다.
    elementType: String | Function,

    // 이 파이버와 연관된 해결된 함수/클래스/입니다.
    // NOTE: 조정후에 해당 함수를 처리하는데 사용하는 값입니다.
    type: String | Function | TContext,
